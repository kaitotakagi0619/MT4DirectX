...
void Object3d::CreateGraphicsPipeline()
{
	...
	ComPtr<ID3DBlob> vsBlob; // 頂点シェーダのオブジェクト
	ComPtr<ID3DBlob> psBlob;    // ピクセルシェーダのオブジェクト
	...
	gpipeline.NumRenderTargets = 1;    // 描画対象の数
...
void Object3d::Update()
{
	...
	matRot *= XMMatrixRotationZ(XMConvertToRadians(rotation.z));//zxyの順番で書かないとダメ
	...
	//cstMap->mat = matWorld * matViewProjection;	// 行列の合成
